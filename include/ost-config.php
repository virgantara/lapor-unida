...
define('SECRET_SALT','YizUU3Gzr1Lf2WlarBvkRU=ne8V4wSE9');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','oddy@unida.gontor.ac.id');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','172.20.20.12');
define('DBNAME','unidagon_lapor');
define('DBUSER','admin_lapor');
define('DBPASS','ehW1PPz6WlVSqtmw');
